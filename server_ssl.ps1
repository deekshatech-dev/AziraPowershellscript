function Test-ServerSSLSupport {
    ...
    process {
        ...
        $RetValue
        # "From " + $TcpClient.client.LocalEndPoint.addresss.IPAddressToString + "to $hostname" + $TcpClient.client.RemoteEndPoint.address.IPAddressToString + ":" + $TcpClient.client.RemoteEndPoint.port
